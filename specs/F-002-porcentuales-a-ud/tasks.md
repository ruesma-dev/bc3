...
- [ ] T41: Test sobre cada `.bc3` de `input/`: tras la pasada con la bandera encendida, **ningún `~C` con descompuesto propio conserva caracteres no ASCII en su resumen** (R25)  |  Verificación: `pytest tests/test_f002_invariante.py -k acentos`
- [ ] T42: Test de R26: R6 ter, R19 y R19 bis pasan con la bandera encendida **y** apagada  |  Verificación: `pytest tests/test_f002_invariante.py -q` parametrizado por la bandera
