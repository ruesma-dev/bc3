...
Resumen: **5 features**, 4 abiertas, 1 terminadas.
...
|---|---|---|---|
| F-002 | Convertir los descompuestos porcentuales a UD con cantidad 1 conservando el importe de Presto | 2 | critico |
...
estado **terminada** · prioridad 2 · rigor `critico` · SDD sí · rama `feature/F-002-porcentuales-a-ud`
