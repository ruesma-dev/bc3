...
| F-002 | Convertir los descompuestos porcentuales a UD con cantidad 1 conservando el importe de Presto | 2 | pendiente | critico | `feature/F-002-porcentuales-a-ud` |
...
estado **pendiente** · prioridad 2 · rigor `critico` · SDD sí · rama `feature/F-002-porcentuales-a-ud`
